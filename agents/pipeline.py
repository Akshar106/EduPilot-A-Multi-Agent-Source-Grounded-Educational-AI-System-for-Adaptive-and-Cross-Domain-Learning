...
from guardrails import scan_chunks
from guardrails.output import OutputVerdict, apply_output_guardrails
from retrieval import HybridRetriever, RetrievalConfig, RetrievalResult
    ...
    def answer(
        ...
        *,
        ...
        try:
            ...
            from security.errors import classify_upstream
