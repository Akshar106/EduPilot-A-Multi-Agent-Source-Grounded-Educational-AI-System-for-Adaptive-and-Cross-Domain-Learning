...
# ---------------------------------------------------------------------------
STATE_DIR: Path = Path(os.getenv("EDUPILOT_STATE_DIR", str(BASE_DIR / ".edupilot")))
...
# Hybrid search blend (must sum to 1.0). Applied by Reciprocal Rank Fusion.
...
# Retained for the legacy retriever until it is removed.
